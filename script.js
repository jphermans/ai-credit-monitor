...
const TRANSLATIONS_NL = {
  ...
  "Check repository and providers.json": t("Check repository and providers.json"),
  "Add provider to catalog": "\u2795 Provider toevoegen aan catalogus",
  "Add provider to providers.json": t("Add provider to providers.json"),
  ...
  "Copy configuration summary to clipboard": t("Copy configuration summary to clipboard"),
  "Language": "\uD83C\uDF10 Language",
  "English": "English",
  "Nederlands": "Nederlands",
  "Use the Raw GitHub URL to providers.json.": t("Use the Raw GitHub URL to providers.json."),
  "Test & save": t("Test & save"),
  "Delete": t("Delete"),
  "Cancel": t("Cancel"),
  "Invalid URL": t("Invalid URL"),
  "Only HTTPS URLs are allowed.": t("Only HTTPS URLs are allowed."),
  "Connection OK": "Verbinding OK",
  "provider(s) found.": "provider(s) gevonden.",
  "Catalog error": t("Catalog error"),
  "Repository containing providers.json.": t("Repository containing providers.json."),
  "Owner / username": "Owner / username",
  "Repository": "Repository",
  "Branch": "Branch",
  "Save": t("Save"),
  "Missing data": t("Missing data"),
  "Fill in all GitHub fields.": t("Fill in all GitHub fields."),
  ...
  "Interval in minutes for widget refresh (5 - 1440).\n\nCurrent: ": t("Interval in minutes for widget refresh (5 - 1440).\n\nCurrent: "),
  "Minutes": t("Minutes"),
  "Enter a number between 5 and 1440 minutes.": t("Enter a number between 5 and 1440 minutes."),
  "Refresh interval set to": "Verversingsinterval ingesteld op",
  "A token is set. The token is never displayed.": t("A token is set. The token is never displayed."),
  "Use a fine-grained token with Contents: Read and write.": t("Use a fine-grained token with Contents: Read and write."),
  "Change token": "\uD83D\uDD04 Token wijzigen",
  "Add token": "\u2795 Token toevoegen",
  "Remove token": "\uD83D\uDDD1 Token verwijderen",
  "The token is stored exclusively in Scriptable Keychain.": t("The token is stored exclusively in Scriptable Keychain."),
  "No token entered.": t("No token entered."),
  "Token saved securely.": t("Token saved securely."),
  "GitHub token deleted.": t("GitHub token deleted."),
  "GitHub token not set.": t("GitHub token not set."),
  "GitHub connection OK": t("GitHub connection OK"),
  "File": "Bestand",
  "GitHub error": t("GitHub error"),
  "GitHub token missing.": t("GitHub token missing."),
  "GitHub response does not contain a file or SHA.": t("GitHub response does not contain a file or SHA."),
  "providers.json could not be read from Base64.": t("providers.json could not be read from Base64."),
  "New provider": t("New provider"),
  "General provider information.": t("General provider information."),
  "ID, e.g. openrouter": t("ID, e.g. openrouter"),
  "Name, e.g. OpenRouter": t("Name, e.g. OpenRouter"),
  "Version": t("Version"),
  "Description": t("Description"),
  "Next": t("Next"),
  "ID, name and version are required.": t("ID, name and version are required."),
  "Provider ID can only contain a-z, 0-9, - and _.": t("Provider ID can only contain a-z, 0-9, - and _."),
  "already exists.": "bestaat al.",
  "Authentication": t("Authentication"),
  "How is the API key sent?": t("How is the API key sent?"),
  "No authentication": t("No authentication"),
  "Custom header": "Custom header",
  "Enter the name of the HTTP header.": t("Enter the name of the HTTP header."),
  "Header": "Header",
  "Prefix": "Prefix",
  "Header name missing.": t("Header name missing."),
  "Enter the balance/credits endpoint of the provider.": t("Enter the balance/credits endpoint of the provider."),
  "API endpoint missing.": t("API endpoint missing."),
  "The API endpoint must use HTTPS.": t("The API endpoint must use HTTPS."),
  "HTTP method": t("HTTP method"),
  "How is the remaining balance in the JSON response?": t("How is the remaining balance in the JSON response?"),
  "Single balance field": "E\u00E9n saldo veld",
  "Total minus used": t("Total minus used"),
  "Array with currencies": t("Array with currencies"),
  "Balance field": t("Balance field"),
  "Example JSON path: data.balance": t("Example JSON path: data.balance"),
  "Currency": t("Currency"),
  "Label": "Label",
  "JSON path missing.": "JSON path ontbreekt.",
  "Credit fields": t("Credit fields"),
  "The remaining balance is calculated as total minus used.": t("The remaining balance is calculated as total minus used."),
  "Total and Used JSON paths are required.": t("Total and Used JSON paths are required."),
  "For APIs that return multiple balances or currencies.": t("For APIs that return multiple balances or currencies."),
  "Array path and amount field are required.": t("Array path and amount field are required."),
  "Add provider?": t("Add provider?"),
  "Add to GitHub": t("Add to GitHub"),
  "Provider added": t("Provider added"),
  ...
  "Adding provider failed": t("Adding provider failed"),
  "No catalog": t("No catalog"),
  "Set the Provider Catalog URL first via Setup.": t("Set the Provider Catalog URL first via Setup."),
  ...
  "Choose a provider from the GitHub catalog.": t("Choose a provider from the GitHub catalog."),
  ...
  "Installation failed": t("Installation failed"),
  "Enter a new key. The old key will be replaced.": t("Enter a new key. The old key will be replaced."),
  "The API key is stored securely in Scriptable Keychain.": t("The API key is stored securely in Scriptable Keychain."),
  "Change": t("Change"),
  "No API key entered.": t("No API key entered."),
  ...
  "Provider Catalog URL missing.": t("Provider Catalog URL missing."),
  "Provider no longer exists in the catalog.": t("Provider no longer exists in the catalog."),
  "Local provider was not found.": t("Local provider was not found."),
  "Provider updated.": "Provider bijgewerkt.",
  "Changes:": "Wijzigingen:",
  "and": "en",
  "more change(s)": "wijziging(en)",
  "No field changes.": t("No field changes."),
  "Update failed": t("Update failed"),
  "Remove": t("Delete"),
  "The local provider and API key will be removed. The provider remains in the GitHub catalog.": t("The local provider and API key will be removed. The provider remains in the GitHub catalog."),
  "Provider deleted.": t("Provider deleted."),
  "No API key set.": t("No API key set."),
  "Custom authentication header missing.": t("Custom authentication header missing."),
  ...
  "No balance found.": t("No balance found."),
  "Balance is not a valid number.": t("Balance is not a valid number."),
  "Unknown response mode.": t("Unknown response mode."),
  "balance low": "saldo laag",
  "Remaining balance:": "Resterend saldo:",
  "Below the threshold of": "Onder de drempel van",
  "No providers": t("No providers"),
  "There are no providers installed yet.": "Er zijn nog geen providers ge\u00EFnstalleerd.",
  "Current remaining balance": t("Current remaining balance"),
  "Last check": t("Last check"),
  "Refresh all balances now": t("Refresh all balances now"),
  "Refresh now": "\uD83D\uDD04 Opnieuw ophalen",
  "No providers configured": t("No providers configured"),
  "more": "meer",
  "Optional future backend that researches provider documentation. API keys are never sent to this backend.": t("Optional future backend that researches provider documentation. API keys are never sent to this backend."),
  "Disable": t("Disable"),
  ...
  "Invalid catalog.": t("Invalid catalog."),
  "providers[] missing.": t("providers[] missing."),
  "Provider missing.": t("Provider missing."),
  "Field missing.": "Veld",
  "Invalid provider ID.": t("Invalid provider ID."),
  "API endpoint must be HTTPS.": t("API endpoint must be HTTPS."),
  "Only GET and POST are allowed.": t("Only GET and POST are allowed."),
  "Invalid response mode.": t("Invalid response mode."),
  "GitHub repository is not fully configured.": t("GitHub repository is not fully configured."),
  "JSON path missing.": t("JSON path missing."),
  ...
  "JSON path not found in response.": t("JSON path not found in response."),
  "Unknown error": t("Unknown error"),
  "[GitHub token hidden]": t("[GitHub token hidden]"),
  "[API key hidden]": t("[API key hidden]")
}
